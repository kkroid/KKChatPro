...
public class FragmentLifecycleCallbacksImpl extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    public void onFragmentAttached(@NotNull FragmentManager fm, @NotNull Fragment f, @NotNull Context context) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentAttached", f.toString());
        }
    }
    ...
    public void onFragmentCreated(@NotNull FragmentManager fm, @NotNull Fragment f, Bundle savedInstanceState) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentCreated", f.toString());
        }
        // 在配置变化的时候将这个 Fragment 保存下来,在 Activity 由于配置变化重建时重复利用已经创建的 Fragment。
        // https://developer.android.com/reference/android/app/Fragment.html?hl=zh-cn#setRetainInstance(boolean)
        // 如果在 XML 中使用 <Fragment/> 标签,的方式创建 Fragment 请务必在标签中加上 android:id 或者 android:tag 属性,
        // 否则 setRetainInstance(true) 无效
    ...
    public void onFragmentViewCreated(@NotNull FragmentManager fm,
        ...
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentViewCreated", f.toString());
        }
    }

    @Override
    public void onFragmentActivityCreated(@NotNull FragmentManager fm,
                                          @NotNull Fragment f,
                                          Bundle savedInstanceState) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentActivityCreated", f.toString());
        }
    }
    ...
    public void onFragmentStarted(@NotNull FragmentManager fm, @NotNull Fragment f) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentStarted", f.toString());
        }
    }
    ...
    public void onFragmentResumed(@NotNull FragmentManager fm, @NotNull Fragment f) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentResumed", f.toString());
        }
    }
    ...
    public void onFragmentPaused(@NotNull FragmentManager fm, @NotNull Fragment f) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentPaused", f.toString());
        }
    }
    ...
    public void onFragmentStopped(@NotNull FragmentManager fm, @NotNull Fragment f) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentStopped", f.toString());
        }
    }

    @Override
    public void onFragmentSaveInstanceState(@NotNull FragmentManager fm,
                                            @NotNull Fragment f,
                                            @NotNull Bundle outState) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentSaveInstanceState", f.toString());
        }
    }
    ...
    public void onFragmentViewDestroyed(@NotNull FragmentManager fm, @NotNull Fragment f) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentViewDestroyed", f.toString());
        }
    }
    ...
    public void onFragmentDestroyed(@NotNull FragmentManager fm, @NotNull Fragment f) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentDestroyed", f.toString());
        }
    }
    ...
    public void onFragmentDetached(@NotNull FragmentManager fm, @NotNull Fragment f) {
        if (BuildConfig.LIFE_DEBUG) {
            Timber.d("%s - onFragmentDetached", f.toString());
        }
    }
}
